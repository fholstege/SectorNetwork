...
l_eigenvectors_nominal_real_2019 = [m2019_nominal_eigenvector,
                                    m2019_real_eigenvector,
...
df_eigenvectors_nominal_real_2019.columns = ['nominal', 'real', 'nominal_normalized','real_normalized']
